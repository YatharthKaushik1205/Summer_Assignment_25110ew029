/*Write a program to perform Subtraction of matrices */
...
int main()
{
    ...
    scanf("%d", &column);
    int matrix1[rows][column], matrix2[rows][column],Subtraction_matrix[rows][column];
    for (i = 0; i < rows;i++)
    {
        for (j = 0; j < column;j++)
        {
    ...
    printf("Subtraction of matrix 2 from matrix 1 is :\n");
    display_matrix(rows, column, Subtraction_matrix);
    return 0;
}
void display_matrix(int a, int b,int arr[a][b])
{
